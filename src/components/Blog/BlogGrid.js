                    ...
                    <div className="col-lg-8 blog_grid_info">
                        <div className="row">
                            <BlogGridItem
                                date="14"
                                month="jan"
                                image="blog_grid_1.jpg"
                                Title="Why I say old chap that is."
                            ...
                            <BlogGridItem
                                date="10"
                                month="jan"
                                image="blog_grid_3.jpg"
                                Title="Kell at public school chee."
                                description="Only a quid bobby brilliant bugger Jeffrey owt to do with me lurgy blimey.!"
                                btn="Read More"
                                comment="3"
                            />
