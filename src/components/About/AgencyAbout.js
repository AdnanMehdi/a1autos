                ...
                <div className="col-lg-6 about_content_left ">
                    <div className="about_content mb_30">
                        ...
                        <p className="f_size_15 f_400 mb_40">
                            ...
                            pardon me buggered mufty Oxford butty bubble and
                            squeak wind up, brown bread the full monty bloke
                            ruddy cras tickety-boo squiffy.!
                        </p>
                    ...
                    <Slider className="about_img_slider" {...settings}>
                        <div className="item">
                            <div className="about_item w45">
                                <img
                                    src={require("../../img/home4/team1.jpg")}
                                    alt=""
                                />
                            ...
                            <div className="about_item w55">
                                <img
                                    src={require("../../img/home4/team2.jpg")}
                                    alt=""
                                />
